...
Applies the EC_POLICY_V1 priority table (README section 4) to findings from
Order & Seller / Payment / Delivery agents: picks the primary_issue, root
...
deterministic given verified data (see architecture.md assumption #3).
"""

from typing import Dict, List

from common import cap, money
...
class PolicyAgent:
    def apply(self, order_seller: Dict, payment: Dict, delivery: Dict) -> Dict:
